...
const DisplayCourses = props => {
    return courses.map(course => {
        if (course.IsTakingCourse == props.isEnrolled) {
            return (
                    ...
                    <CardActionArea>
                        ...
                        <CardContent>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                This is may be a small summary of the course.
                            </Typography>}
                        </CardContent>
                    </CardActionArea>
                </Card>
                {props.isEnrolled ? <Box sx={{ display: 'flex' }} style={{padding: 5}}>
                                <Box sx={{ width: '95%', mr: 1 }}>
                                    <LinearProgress borderRadius="5" variant="determinate" {...course.CourseProgress} value={course.CourseProgress} />
                                </Box>
    ...
    return (
        <div className="page-content">
            ...
            <div className='my-courses-content'>
                <DisplayCourses isEnrolled={true}/>
            </div>
            ...
            <div className='all-courses-content'>
                <DisplayCourses isEnrolled={false}/>
            </div>
